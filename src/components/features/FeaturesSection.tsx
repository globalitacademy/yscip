    ...
    <section id="features-section" className="py-12 sm:py-16 md:py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <FadeIn delay="delay-100">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4 lg:mb-6 text-center tracking-tight">
            Համակարգի հիմնական առանձնահատկությունները
          </h2>
        </FadeIn>
        
        <FadeIn delay="delay-200">
          <p className="text-sm sm:text-base text-muted-foreground text-center max-w-2xl mx-auto mb-8 md:mb-12 lg:mb-16 px-4">
