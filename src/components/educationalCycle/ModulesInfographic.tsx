              ...
              >
                ...
                <div className="mt-auto">
                  <Button 
                    ...
                    size="sm" 
                    variant="outline"
                    className={`${module.textColor} border-current hover:bg-opacity-10 hover:bg-current dark:hover:bg-opacity-10 dark:hover:bg-current hover:text-gray-900 dark:hover:text-white`}
                  >
