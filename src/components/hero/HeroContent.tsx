    ...
    <div className="container px-4 mx-auto text-center z-10 py-16">
      ...
      <SlideDown delay="delay-200">
        <h1 className="md:text-5xl lg:text-6xl font-bold mb-8 leading-tight tracking-tight text-base xl:text-5xl">
          <span className="relative inline-block bg-clip-text text-transparent bg-gradient-to-r from-foreground via-foreground/90 to-foreground/70 font-semibold text-4xl">Սկսիր մասնագիտական ուղիդ</span>
          <br />
          <span className="relative inline-block mt-2">
            <span className="relative z-10 bg-clip-text text-transparent bg-gradient-to-r from-primary via-primary/90 to-primary/70 text-5xl">Ուսուցում առանց սահմանների</span>
      ...
      <SlideDown delay="delay-300">
        <p className="max-w-xl mx-auto md:text-xl text-muted-foreground mb-12 tracking-wide">
      ...
      <FadeIn delay="delay-500">
        <div className="flex flex-wrap justify-center gap-6">
          ...
          <a 
            href="#courses" 
            className="px-8 py-4 bg-gradient-to-r from-secondary/30 to-secondary/10 text-secondary-foreground font-medium rounded-lg border border-secondary/30 hover:shadow-lg hover:translate-y-[-4px] transition-all duration-300 backdrop-blur-sm relative overflow-hidden group"
          >
